...
class MainWindow(QMainWindow):
    ...
    def _build_settings_page(self) -> QWidget:
        ...
        layout.addWidget(self._metric_panel("蓝牙模块", QLabel("JDY-24M"), "支持 BLE FEE1 与模拟数据源切换"), 0, 1)
        layout.addWidget(self._metric_panel("BLE 特征", QLabel("FEE1"), "JDY-24M 透传特征 UUID"), 1, 0)
    ...
    def _build_source_panel(self) -> QWidget:
        ...
        hint = QLabel("模拟数据用于界面开发；真实数据通过电脑蓝牙订阅 JDY-24M 的 FEE1 特征")
